...
HAL_StatusTypeDef AT24C512_Write(I2C_HandleTypeDef *hi2c,uint16_t memAddress, uint8_t *data, uint16_t dataSize);
...
#define EE_RECETE_DATA_SIZE			8
#define EE_RECETE_ISIM_ROW			EE_RECETE_DATA_SIZE
...
#define EE_OTOMATIK_ACMA_PARAM_SIZE		16
...
#define EE_OTOMATIK_RECETE_ROW_ADR		EE_OTOMATIK_ACMA_ILK_ADR + 14
